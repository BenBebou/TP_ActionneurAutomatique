...
uint8_t help[]="Appel de la fonction d'aide\r\n";
uint8_t pinout[]="Pinout de la carte Nucleo :\r\n";
  ...
  while (1)
  {
	  // uartRxReceived is set to 1 when a new character is received on uart 1
	  	  ...
	  	  if(newCmdReady){ ////////////////////////////////////////////////////
	  		  ...
	  		  if(strcmp(argv[0],"help")==1){
	  			  HAL_UART_Transmit(&huart2, help, 32, HAL_MAX_DELAY);
	  			  // Appel de la fonction "help"
	  			  help();
	  		  }
	  		  else if(strcmp(argv[0], "pinout")==1)
	  		  {
	  			  HAL_UART_Transmit(&huart2, pinout, 32, HAL_MAX_DELAY);
